...
def get_entity_bioes(seq, id2label, label2id):
...
def get_entities(seq, id2label, label2id, markup='BIOES'):
    '''
    :param seq:
    :param id2label:
    :param markup:
    ...
    return get_entity_bioes(seq, id2label, label2id)


class SeqEntityScore(object):
    def __init__(self, id2tag, label2id, markup='BIOES', label='plain'):
        self.origins = []
        self.founds = []
        self.rights = []
        self.right_cut = []
    ...
    def update(self, gt, pred_paths):
        for label_entities, pre_path in zip(gt, pred_paths):
            pre_entities = get_entities(pre_path, self.id2label, self.label2id, self.markup)
